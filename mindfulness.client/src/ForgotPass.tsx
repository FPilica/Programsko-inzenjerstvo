    ...
    <>
      ...
      <div className='containerForgot'>
        ...
        <div className="forgotpassInfo">
          ...
          <p>Poslat ćemo Vam link za ponovno postavljanje lozinke na vašu e-mail adresu.</p>
        </div>
        <form className="formForgotpass" onSubmit={handleSubmit}>
          ...
          <div className="buttonsForgotpass">
            <button className='cancel' type="button" onClick={() => navigate('/auth/login')}>Odustani</button>
            <button className='submit' type="submit">Pošalji</button>
          </div>
        </form>
